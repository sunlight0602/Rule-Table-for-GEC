...
with open('./data/verb_pattern.json') as f:
...
if __name__=='__main__':
    ...
    error_file = open('./results/Error_message.txt','w')
    ...
    input_f_idx = enumerate(open('./data/EF877.edit.sm.txt'))
    ...
    # Output json file
    with open('./results/Error_pattern.json', 'w') as f:
    ...
    with open('./results/Error_pattern.txt', 'w') as f:
        for line in hw_pat_dict:
            f.write(str(line)+'\n')

    # Output example json file
    with open('./results/Error_pattern_example.json','w') as f:
    ...
    with open('./results/Error_pattern_example.txt', 'w') as f:
