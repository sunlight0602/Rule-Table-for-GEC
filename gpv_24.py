...
with open('./data/alignment.json') as f:
    Spacy_Collins = json.load(f)

with open('./data/Collins_verb_pattern.txt') as f:
...
if __name__ == '__main__':
    ...
    sent = 'About this course: Myths are traditional stories that have endured over a long time.'
